...
/*CREATES AUDIT TABLE FOR USER ACCOUNTS (NOT NEEDED)*/
CREATE TABLE [dbo].[Basiscore_CmsAudit_Accounts](
    [RowId] [bigint] IDENTITY(1,1) NOT NULL,
	...
	[Comments] [nvarchar](4000) NULL,
    [LoggedTime] [datetime] NULL,
 CONSTRAINT [PK_Basiscore_CmsAudit_UserAccounts] PRIMARY KEY CLUSTERED 
(
    [RowId] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
) ON [PRIMARY]
...
/*CREATES STORED PROCEDURE TO INSERT CMS USER ACCOUNT AUDIT LOG (NOT NEEDED)*/
CREATE PROCEDURE usp_Basiscore_CmsAudit_InsertAccountAuditLog
...
BEGIN
    ...
    INSERT INTO Basiscore_CmsAudit_Accounts(
		UserId,
		Username,
		FullName,
		Email,

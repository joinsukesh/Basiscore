<%@ Page Title="Add Rendering" Language="C#" MasterPageFile="~/sitecore/admin/minions/Default.Master" AutoEventWireup="true" CodeBehind="addrendering.aspx.cs" Inherits="Basiscore.Minions.sitecore.admin.minions.addrendering" %>

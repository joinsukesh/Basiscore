...
![image001](https://user-images.githubusercontent.com/24619393/229768838-33be62c8-0726-4184-8a83-63ed6ece4c65.png)
...
1.	Download the latest version from the website - https://datalust.co/download
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229769292-40742368-6470-4559-b478-16d7865b4925.png)


2.	Run the executable and follow the instructions.

 ![image](https://user-images.githubusercontent.com/24619393/229769335-902289e8-e6d6-478e-877f-3ddfc3b5ca3d.png)

![image](https://user-images.githubusercontent.com/24619393/229769399-fb43d017-3573-4f50-b35c-ffd0f1f070eb.png)

![image](https://user-images.githubusercontent.com/24619393/229769433-3c41b136-5557-4571-bdd9-d4e0f90e39b8.png)

![image](https://user-images.githubusercontent.com/24619393/229769460-62a2c92a-2c62-4d07-ac01-eafec68424b5.png)

![image](https://user-images.githubusercontent.com/24619393/229769483-97dbd57d-d587-4d4c-b28d-573a97dba9a1.png)

![image](https://user-images.githubusercontent.com/24619393/229769496-cadc897c-52fc-4a98-8cb2-f8fa870f8a22.png)
...
We’ll start with creating **Filters** & **Signals**. A _Signal_ is a collection of filters in Seq. You may find one or two default _Signals_ like this:
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229769653-cf847c77-8aec-43dc-a1a3-54a0a34d7d0b.png)
...
1.	Let us create a filter for _Debug_ logs. Select the **Errors** filter and click the pencil icon to edit.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229769924-a7e3a0d7-60b6-4ad5-986d-7f204b1f9382.png)


2.	In the dropdown, select **Clone** to create a clone of this filter. 

 ![image](https://user-images.githubusercontent.com/24619393/229769975-ba92b2f0-95cc-420c-af66-9eaec13a5c3f.png)

![image](https://user-images.githubusercontent.com/24619393/229770015-dd5fd363-cb82-4052-8532-9384b6e53d17.png)
...
3.	Rename the Title to _Debug_. Change the text in **FILTERS** & **GROUP** section as shown.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229770119-c1fd8b97-7c67-4956-8a69-c8a33e291641.png)
...
4.	Click the Save icon to save this filter.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229770240-401ae702-cc5b-4b2f-95ed-88e5921b0010.png)
...
To create a new Signal, click on the + icon.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229770549-167837fa-cd13-4d6e-bb0d-6024051249aa.png)
...
Edit the _Title_. Let’s say, your application’s name is ‘_Stratum_’. You can set the same name as the title. Click on the Save icon.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229770623-cf985a40-4fe9-4d94-9c13-473f13a80584.png)
...
In the Search Box, type this query _Application = ‘Stratum’_ and click the **Add Filter** icon.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229770718-472b0731-8454-4c45-95a1-0d0b058fa529.png)


This will add the filter to your _Signal_. Click on the _Save_ icon to save this _Signal_.

 ![image](https://user-images.githubusercontent.com/24619393/229770787-690ab6eb-1fc8-4a2c-b40d-86bff7ba6ece.png)
...
1.	Open the **\App_config\Include\zzz.Basiscore\Basiscore.SeqLogger.config** file and set **includesystemlogs** to _true_ and save the file.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229771324-e02c31a8-c0f7-4f5e-ad48-c03769849ca5.png)
...
![image](https://user-images.githubusercontent.com/24619393/229771432-84acc254-f4e5-49f9-b280-e7e022722ca7.png)
...
<table>
  ...
  <tr>
    ...
    <td>The property ‘Application’ and the configured value (e.g., ‘Stratum’) will be sent to the Seq API and it will be rendered like this:
      
 ![image](https://user-images.githubusercontent.com/24619393/229771813-41470712-d18c-47a2-83de-9144a71bf018.png)
  ...
  <tr>
    ...
    <td>Setting this to true, will capture the Sitecore’s default logs. By default, it is set to false. This will capture only the application logs, i.e., logs that you are capturing in your code e.g., _Log.Error(“”, exception, this);_</td>
  </tr>
  <tr>
...
e.g.: _Environment,Local|Source,Web_ 
      ![image](https://user-images.githubusercontent.com/24619393/229772198-f24dd4d9-659d-4812-b016-74f581ec6824.png)
    </td>
  </tr>
  <tr>
    <td>level</td>
...
Use Sitecore’s default log methods which accept the “object owner” argument.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229772313-84911746-f6de-4dac-be09-02aa35f29662.png)


This would render logs like this:

 ![image](https://user-images.githubusercontent.com/24619393/229772344-f436d78e-1507-4be3-9e0f-a51c09be80bc.png)
...
**#1 Pass them as a JSON string of _List<KeyValuePair<string, string>>_**
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229772513-b5d0dc0d-b2ef-4f03-91a8-d25ea37500e8.png)


Which will render like this:

 ![image](https://user-images.githubusercontent.com/24619393/229772526-17f26693-bf23-44e6-a68b-b03ec957f80d.png)


**#2 Pass an object as JSON string**

 ![image](https://user-images.githubusercontent.com/24619393/229772586-0524036f-ee8c-4718-aafc-d006bdbd4eff.png)


Which will render like this:

 ![image](https://user-images.githubusercontent.com/24619393/229772612-4d2a5f84-8571-47e8-ae35-5b2188e7775d.png)
...
The contents of this file are like this:
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229772683-9ac856f9-7f5f-471f-8883-cf79a87fba28.png)
...
This will ingest the file content as logs into _Seq_, like this:
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229772807-5dabdfb2-03e7-4981-b4d4-ec3232b026ca.png)
...
Go to **Settings** > **Retention** and click on **MANUALLY DELETE EVENTS**.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229773313-f800678b-7dc7-4e9c-8923-9b75ba6eb5ff.png)
...
You can filter the existing entries and then click on the **Delete** icon. This will only delete the current filtered logs. If there are no filters selected, then it will delete all the logs.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229773352-7c3e7f68-45a9-4cb0-b7ee-786b7f121283.png)
...
Go to **Settings** > **Retention**. Click on **ADD POLICY**.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229773414-60fa9470-238e-41c0-8f2f-a6207794fb4c.png)
...
![image](https://user-images.githubusercontent.com/24619393/229773508-e0840a4b-6282-47ea-b6e8-a52c81a232c1.png)
...
If you restart your machine, the Seq service may not start automatically and the Seq page will not load.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229773624-14b04ab2-f01f-4cfc-8326-0c024267fe7c.png)


In such case, open the Seq tool and do the setup again. That should work.

 ![image](https://user-images.githubusercontent.com/24619393/229773694-4bbab810-8478-40df-b7b8-d218d62f88e2.png)

![image](https://user-images.githubusercontent.com/24619393/229773711-687efe7e-f244-4c64-a7c2-3147846fe034.png)

![image](https://user-images.githubusercontent.com/24619393/229773742-f9735f96-291c-4e14-9350-429b833d5fe1.png)

![image](https://user-images.githubusercontent.com/24619393/229773770-6d462612-5230-410a-9a63-617a900a067e.png)
...
If in any case, you see a prompt to enter credentials and you forgot them, they can be reset.
 ...
 ![image](https://user-images.githubusercontent.com/24619393/229773826-0e5a21fd-9cba-4eb0-9354-7517d2671053.png)

Execute this command in Windows Command Prompt

 ![image](https://user-images.githubusercontent.com/24619393/229773860-fd8c51ed-e2bc-4b5a-990e-c58de6979475.png)

![image](https://user-images.githubusercontent.com/24619393/229773882-169e1b9c-9e4b-4d0f-bf5d-877a1baa5d12.png)

![image](https://user-images.githubusercontent.com/24619393/229773904-d3aa50d4-de26-416e-92ef-f9a28e2e3898.png)

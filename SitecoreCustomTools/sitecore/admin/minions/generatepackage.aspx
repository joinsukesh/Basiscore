<%@ Page Title="Generate Package" Language="C#" MasterPageFile="~/sitecore/admin/minions/Default.Master" AutoEventWireup="true" CodeBehind="generatepackage.aspx.cs" Inherits="SitecoreCustomTools.sitecore.admin.minions.generatepackage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <%--<button type="button" id="btnGeneratePackage" class="btn btn-primary pull-right">GENERATE PACKAGE</button>--%>
    ...
    <script>
        ...
        function GetDataModel() {
            ...
            dataModel.PackageName = $.trim($("#txtPackageName").val());
            dataModel.Author = $.trim($("#txtAuthor").val());
            dataModel.Version = $.trim($("#txtVersion").val());
            dataModel.ItemPathsToIncludeWithSubitems = $("#txtIncludeWithSubitems").val();
            dataModel.ItemPathsToInclude = $("#txtIncludeItems").val();
            return dataModel;
        }
        ...
        function OnSubmit(dataModel) {
            $.ajax({
                type: "POST",
                url: "generatepackage.aspx/GenerateSitecorePackage",
                data: JSON.stringify({ generatePackageDataModel: dataModel }),
                ...
                success: function (data) {
                    setTimeout(
                        function () {
                            ...
                            if (objData != null) {
                                if (objData.ResultStatus == 0 || objData.ResultStatus == 1) {
                                    $(".divStatusContainer").html(objData.ResultMessage);
                                    $(".divStatusContainer").show();
                                    $(".divStatusContainer").focus();
                                }
                                else if (objData.ResultStatus == 2) {
